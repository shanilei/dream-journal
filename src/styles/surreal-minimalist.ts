...
SUBJECT RULES:
Human figures and body parts are welcome and encouraged when they serve the composition. A hand reaching into frame, a torso half-submerged, a pair of legs standing in an impossible environment, a figure seen from behind or in silhouette — all of these are valid and strong choices. Body parts may be partially visible, cropped, or integrated into the scene as long as they do not feel like a clinical anatomy study. The one absolute rule: no directly depicted human face — never a bare, exposed, readable face. If a face must appear, it must always be concealed or replaced: a mask, a veil, petals, fabric, shadow, a mirror reflection distorted beyond recognition, or another object placed over it. A silhouette, a figure turned away, or a face obscured by an element of the scene are all valid. Never let a face resolve into something nameable or identifiable. No frozen catalog or stock-photo pose.
