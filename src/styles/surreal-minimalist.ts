...
Every image MUST include a LONG EXPOSURE element somewhere in the frame: something genuinely in motion — light, water, smoke, a spinning figure, drifting particles, a trailing glow — captured the way a slow shutter would, leaving a real streak or trail of light or movement. If nothing in the dream's content suggests an obvious moving subject, make this small and localized — a thin trailing light streak, a soft drifting wisp — but it must always be present in some form. Everything stationary around it stays completely sharp.
...
SUBJECT RULES:
If a human figure appears: no identifiable face, no readable expression, no frozen catalog pose — only a body genuinely spinning or whirling (motion-blurred into an arc or spiral) or dissolving into glow/light. Never let a face resolve into something nameable.
