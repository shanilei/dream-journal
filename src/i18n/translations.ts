...
export const translations = {
  en: {
    ...
    settingsDark: "Dark",
    settingsLight: "Light",
    settingsInterpLength: "AI Interpretation Length",
    settingsLong: "Long",
    ...
    onboarding3Subtitle: "Lucid analyzes emotions, symbols and recurring themes and creates a unique memory for every dream",
  ...
  he: {
    ...
    onboarding3Subtitle: "לוסיד מזהה רגשות, סמלים ונושאים שחוזרים על עצמם, ויוצרת זיכרון חזותי ייחודי לכל חלום.",
